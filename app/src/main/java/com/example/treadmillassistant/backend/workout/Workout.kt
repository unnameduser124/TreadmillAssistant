...
class Workout(val ID: Int = 0,var workoutTime: Date, var workoutDuration: Int, var treadmill: Treadmill, var mediaLink: String, var workoutStatus: WorkoutStatus, var currentMoment: Int = 0, var workoutPlan: WorkoutPlan) {
